...
public class PersonalAccRegistrationPage extends Config_Properties {
	...
	WebElement clickOnFAQsIcon;
	@FindBy(xpath = "//*[@id=\"ifhFaqControlOC2766\"]")
	WebElement clickOnFAQs_1_Que;
	@FindBy(xpath = "//button[@title='Experiencing issues?']")
	WebElement clickOnSuerveyIcon;
	@FindBy(xpath = "//textarea[@id='ifhTextArea_0']")
